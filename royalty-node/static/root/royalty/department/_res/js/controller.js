var app = angular.module('department', [{
    files:[
        "root/royalty/department/_res/js/service.js"
    ]
}]);
app.controller('departmentCtrl',function ($scope,$state) {
...
}).controller('departmentMenuCtrl',function($scope,$state,$rootScope,$location,departmentSer){
    ...
    $scope.menuCheck = function (name) {
        ...
        departmentSer.menuPermission(buttonName).then(function(response){
