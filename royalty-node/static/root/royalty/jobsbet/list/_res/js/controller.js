var app = angular.module('jobsbetList', ['ng-pagination','toastr']);
app.controller('jobsbetListCtrl',function($scope,jobsbetSer,toastr,$stateParams,$state,$location) {
    $scope.a1=function(){
        $scope.visible = true;
    }
    ...
    $scope.delFn = function(){
        ...
        jobsbetSer.JobsbetDelete(data).then(function(response){
            if(response.data.code==0){
                ...
                if(($scope.abili.itemsCount-count)%10){
                    ...
                    $state.go('root.royalty.jobsbet.list[12]',{id:null,name:null,page:$stateParams.page-1});
                }
            }else{
    ...
    function activatePage(page) {
        ...
        jobsbetSer.listJobsbet(listData).then(function(response){
            if(response.data.code==0) {
    ...
    jobsbetSer.countJobsbet().then(function(response){
        if(response.data.code==0){
