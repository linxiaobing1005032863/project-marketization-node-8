var app = angular.module('jobsbetCollect', ['ng-pagination','toastr']);
app.controller('jobsbetCollectCtrl',function($scope,jobsbetSer,toastr,$stateParams,$state,$location) {
/*    $scope.a1=function(){
        $scope.visible = true;
    }
    ...
    $scope.showed=true;
    // 获取项目名称
    jobsbetSer.projectName().then(function(response){
        if(response.data.code == 0){
    ...
    $scope.collect = function(){
        ...
        jobsbetSer.jobsbetCollect(vm.sum).then(function(response){
